...
const Swap = ({ onClose }) => {
  ...
  const handleDeleteBook = async (bookId) => {
    try {
      await axios.delete(`https://book-swapping-platform.vercel.app:3000/books/${bookId}`);
  ...
  const handleSwap = async () => {
    ...
    try {
      ...
      await axios.delete(`https://book-swapping-platform.vercel.app:3000/books/${bookToDelete._id}`);
