...
const Swap = ({ onClose }) => {
  ...
  const fetchUserBooks = async () => {
    try {
      const response = await axios.get(`https://bookswap-platform.onrender.com/books`);
  ...
  const handleDeleteBook = async (bookId) => {
    try {
      await axios.delete(`https://bookswap-platform.onrender.com/books/${bookId}`);
  ...
  const handleSwap = async () => {
    ...
    try {
      ...
      await axios.delete(`https://bookswap-platform.onrender.com/books/${bookToDelete._id}`);
